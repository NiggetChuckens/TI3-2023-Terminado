...
final List<Specialist> specialists = [
  const Specialist(name: 'Juan Perez', category: 'Terapia', rating: 4.5,  image: 'lib/images/doctor2.jpg'),
  const Specialist(name: 'Maria Garcia', category: 'Terapia', rating: 4.2, image: 'lib/images/doctor2.jpg'),
  const Specialist(name: 'Pedro Rodriguez', category: 'Psicologia', rating: 4.8, image: 'lib/images/doctor2.jpg'),
  ...
  const Specialist(name: 'Sofia Diaz', category: 'Doctor', rating: 4.3, image: 'lib/images/doctor2.jpg'),
  const Specialist(name: 'Javier Gomez', category: 'Doctor', rating: 4.0, image: 'lib/images/doctor2.jpg'),
  const Specialist(name: 'Javiera Diaz', category: 'Psicologia', rating: 4.2, image: 'lib/images/doctor2.jpg'),
];