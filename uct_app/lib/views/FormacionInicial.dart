...
class Formacioninicialdocente extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.lightBlue, // Fondo azul claro
        title: Text('', style: TextStyle(color: Colors.white)), // Título en blanco
      ),
      body: Padding(
