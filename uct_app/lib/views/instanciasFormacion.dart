...
class VistaConImagen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Colors.lightBlue, // Cambia el color de fondo a azul claro
      appBar: AppBar(
  ...
  Widget _crearImagen(BuildContext context, String rutaImagen, int index, List<String> urls) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(15.0), // Redondea las esquinas de la imagen
        ),
        child: ClipRRect(
          borderRadius: BorderRadius.circular(15.0), // Redondea las esquinas de la imagen
          child: Image.asset(
